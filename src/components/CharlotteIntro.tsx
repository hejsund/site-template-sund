        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 order-1 md:order-2">
            ...
            <div className="space-y-3 sm:space-y-4 text-sm sm:text-base md:text-lg text-green-800 leading-relaxed font-text">
              ...
              <p>
                <span className="text-coral font-medium">Inga pekpinnar, inga förbud</span> – bara verktyg som hjälper dig att skapa den sommar DU vill ha.
              </p>
            </div>
        ...
        <div className="mt-12 sm:mt-16 relative">
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white">
              ...
              <h3 className="text-base sm:text-lg font-medium font-display text-white drop-shadow-lg">Träning kan vara roligt och enkelt</h3>
              <p className="text-xs sm:text-sm opacity-90 font-text text-white drop-shadow-md">Hitta din egen väg till rörelse</p>
            </div>
          </div>
        </div>
      </div>
