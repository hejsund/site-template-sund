...
export const FooterSection = () => {
  return (
    <footer className="relative bg-gradient-to-br from-green-800 to-green-900 text-white overflow-hidden">
      {/* Decorative wave */}
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="text-green-200 hover:text-white transition-colors duration-200 p-2 rounded-full hover:bg-green-700"
