    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="max-w-sm sm:max-w-md w-[90vw] sm:w-[400px] h-auto p-0 border-none bg-transparent shadow-none">
        <div className="relative w-full">
          ...
          {/* Video container - portrait with orientation parameter */}
          <div className="w-full bg-black rounded-lg overflow-hidden">
            <div className="relative w-full" style={{ paddingTop: '177.77777777777777%' }}>
              <iframe
                src="https://customer-cb54xmjlmqvsgehg.cloudflarestream.com/26a0dbe82ebc64692ab0d64b9473b884/iframe?preload=true&autoplay=true&orientation=portrait&poster=https%3A%2F%2Fcustomer-cb54xmjlmqvsgehg.cloudflarestream.com%2F26a0dbe82ebc64692ab0d64b9473b884%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600"
                loading="lazy"
